...
char z_data_chr_arm_arm_anm__name[21];
fsFile z_data_chr_arm_arm_anm__info[1];
fsFileIndex data_chr_arm_arm_anm[1];
char z_data_chr_arm_arm_kg1__name[21];
fsFile z_data_chr_arm_arm_kg1__info[1];
fsFileIndex data_chr_arm_arm_kg1[1];
char z_data_chr_arm_arm_mdl__name[21];
fsFile z_data_chr_arm_arm_mdl__info[1];
fsFileIndex data_chr_arm_arm_mdl[1];
