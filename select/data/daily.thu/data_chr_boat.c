...
char z_data_chr_boat_boat_anm__name[23];
fsFile z_data_chr_boat_boat_anm__info[1];
fsFileIndex data_chr_boat_boat_anm[1];
char z_data_chr_boat_boat_mdl__name[23];
fsFile z_data_chr_boat_boat_mdl__info[1];
fsFileIndex data_chr_boat_boat_mdl[1];
