...
char z_data_chr_bos_bos_anm__name[21];
fsFile z_data_chr_bos_bos_anm__info[1];
fsFileIndex data_chr_bos_bos_anm[1];
char z_data_chr_bos_bos_mdl__name[21];
fsFile z_data_chr_bos_bos_mdl__info[1];
fsFileIndex data_chr_bos_bos_mdl[1];
