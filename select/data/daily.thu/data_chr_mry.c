...
char z_data_chr_mry_mry_mdl__name[21];
fsFile z_data_chr_mry_mry_mdl__info[1];
fsFileIndex data_chr_mry_mry_mdl[1];
char z_data_chr_mry_p_mry_anm__name[23];
fsFile z_data_chr_mry_p_mry_anm__info[1];
fsFileIndex data_chr_mry_p_mry_anm[1];
