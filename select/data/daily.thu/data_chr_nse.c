...
char z_data_chr_nse_nse_anm__name[21];
fsFile z_data_chr_nse_nse_anm__info[1];
fsFileIndex data_chr_nse_nse_anm[1];
char z_data_chr_nse_nse_kg1__name[21];
fsFile z_data_chr_nse_nse_kg1__info[1];
fsFileIndex data_chr_nse_nse_kg1[1];
char z_data_chr_nse_nse_mdl__name[21];
fsFile z_data_chr_nse_nse_mdl__info[1];
fsFileIndex data_chr_nse_nse_mdl[1];
char z_data_chr_nse_nse_st_mdl__name[24];
fsFile z_data_chr_nse_nse_st_mdl__info[1];
fsFileIndex data_chr_nse_nse_st_mdl[1];
