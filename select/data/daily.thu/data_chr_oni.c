...
char z_data_chr_oni_oni_anm__name[21];
fsFile z_data_chr_oni_oni_anm__info[1];
fsFileIndex data_chr_oni_oni_anm[1];
char z_data_chr_oni_oni_kg1__name[21];
fsFile z_data_chr_oni_oni_kg1__info[1];
fsFileIndex data_chr_oni_oni_kg1[1];
char z_data_chr_oni_oni_mdl__name[21];
fsFile z_data_chr_oni_oni_mdl__info[1];
fsFileIndex data_chr_oni_oni_mdl[1];
