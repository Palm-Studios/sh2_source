...
char z_data_chr_pap_pap_anm__name[21];
fsFile z_data_chr_pap_pap_anm__info[1];
fsFileIndex data_chr_pap_pap_anm[1];
char z_data_chr_pap_pap_kg1__name[21];
fsFile z_data_chr_pap_pap_kg1__info[1];
fsFileIndex data_chr_pap_pap_kg1[1];
char z_data_chr_pap_pap_mdl__name[21];
fsFile z_data_chr_pap_pap_mdl__info[1];
fsFileIndex data_chr_pap_pap_mdl[1];
