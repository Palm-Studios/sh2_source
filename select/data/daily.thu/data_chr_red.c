...
char z_data_chr_red_red_anm__name[21];
fsFile z_data_chr_red_red_anm__info[1];
fsFileIndex data_chr_red_red_anm[1];
char z_data_chr_red_red_kg1__name[21];
fsFile z_data_chr_red_red_kg1__info[1];
fsFileIndex data_chr_red_red_kg1[1];
char z_data_chr_red_red_mdl__name[21];
fsFile z_data_chr_red_red_mdl__info[1];
fsFileIndex data_chr_red_red_mdl[1];
