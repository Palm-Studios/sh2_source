...
char z_data_chr_scu_scu_anm__name[21];
fsFile z_data_chr_scu_scu_anm__info[1];
fsFileIndex data_chr_scu_scu_anm[1];
char z_data_chr_scu_scu_kg1__name[21];
fsFile z_data_chr_scu_scu_kg1__info[1];
fsFileIndex data_chr_scu_scu_kg1[1];
char z_data_chr_scu_scu_mdl__name[21];
fsFile z_data_chr_scu_scu_mdl__info[1];
fsFileIndex data_chr_scu_scu_mdl[1];
char z_data_chr_scu_scu_st_mdl__name[24];
fsFile z_data_chr_scu_scu_st_mdl__info[1];
