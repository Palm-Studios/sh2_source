...
char z_data_chr_xoo_xoo_anm__name[21];
fsFile z_data_chr_xoo_xoo_anm__info[1];
fsFileIndex data_chr_xoo_xoo_anm[1];
char z_data_chr_xoo_xoo_kg1__name[21];
fsFile z_data_chr_xoo_xoo_kg1__info[1];
fsFileIndex data_chr_xoo_xoo_kg1[1];
char z_data_chr_xoo_xoo_mdl__name[21];
fsFile z_data_chr_xoo_xoo_mdl__info[1];
fsFileIndex data_chr_xoo_xoo_mdl[1];
