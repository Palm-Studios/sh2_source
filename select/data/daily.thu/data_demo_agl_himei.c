...
char z_data_demo_agl_himei_agl_himei_dds__name[34];
fsFile z_data_demo_agl_himei_agl_himei_dds__info[1];
fsFileIndex data_demo_agl_himei_agl_himei_dds[1];
char z_data_demo_agl_himei_hll_jms_anm__name[32];
fsFile z_data_demo_agl_himei_hll_jms_anm__info[1];
