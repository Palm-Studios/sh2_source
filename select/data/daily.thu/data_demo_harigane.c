...
char z_data_demo_harigane_harigane_dds__name[32];
fsFile z_data_demo_harigane_harigane_dds__info[1];
fsFileIndex data_demo_harigane_harigane_dds[1];
char z_data_demo_harigane_hll_jms_anm__name[31];
fsFile z_data_demo_harigane_hll_jms_anm__info[1];
