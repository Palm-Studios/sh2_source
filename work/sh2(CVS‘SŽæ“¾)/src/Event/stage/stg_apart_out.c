...
typedef unsigned char type_38[194];
...
typedef _AnimeInfo type_45[33];
typedef CharaData_DemoList type_46[2];
typedef _AnimeInfo type_47[21];
typedef char type_48[0];
typedef unsigned char type_49[2];
typedef CharaData_DemoList type_50[2];
typedef unsigned char type_51[2];
typedef Model_List type_52[4];
...
fsFileIndex data_demo_tobira_c_tobira_c_dds[1];

int EvProgGetCoinOfSnake();
int EvProgGetCoinOfOldman();
int EvProgMurderNewsRead();
int EvProgApartEastToWest();
int EvProgApartWestToEast();
void EvStageInit();
void EvAllTimeFunc();
...
// 
// Start address: 0x1f022f0
int EvProgApartEastToWest()
{
	int ret;
	DramaDemo_PlayInfo door_b;
	DramaDemo_PlayInfo door_a;
	CharaData_DemoList chara_data[2];
	// Line 205, Address: 0x1f022f0, Func Offset: 0
	// Line 223, Address: 0x1f022fc, Func Offset: 0xc
	// Line 225, Address: 0x1f02344, Func Offset: 0x54
	// Line 226, Address: 0x1f0235c, Func Offset: 0x6c
	// Line 227, Address: 0x1f02374, Func Offset: 0x84
	// Line 228, Address: 0x1f02384, Func Offset: 0x94
	// Line 229, Address: 0x1f02398, Func Offset: 0xa8
	// Line 230, Address: 0x1f023a4, Func Offset: 0xb4
	// Line 231, Address: 0x1f023b8, Func Offset: 0xc8
	// Line 232, Address: 0x1f023d0, Func Offset: 0xe0
	// Line 233, Address: 0x1f023ec, Func Offset: 0xfc
	// Line 234, Address: 0x1f02400, Func Offset: 0x110
	// Line 238, Address: 0x1f02410, Func Offset: 0x120
	// Line 239, Address: 0x1f02428, Func Offset: 0x138
	// Line 240, Address: 0x1f02460, Func Offset: 0x170
	// Line 242, Address: 0x1f02474, Func Offset: 0x184
	// Line 245, Address: 0x1f0247c, Func Offset: 0x18c
	// Line 246, Address: 0x1f024a4, Func Offset: 0x1b4
	// Line 249, Address: 0x1f024ac, Func Offset: 0x1bc
	// Line 250, Address: 0x1f024c0, Func Offset: 0x1d0
	// Line 251, Address: 0x1f024f0, Func Offset: 0x200
	// Line 252, Address: 0x1f02504, Func Offset: 0x214
	// Line 253, Address: 0x1f02520, Func Offset: 0x230
	// Line 256, Address: 0x1f02528, Func Offset: 0x238
	// Line 257, Address: 0x1f02538, Func Offset: 0x248
	// Line 258, Address: 0x1f02544, Func Offset: 0x254
	// Line 259, Address: 0x1f02550, Func Offset: 0x260
	// Line 260, Address: 0x1f0255c, Func Offset: 0x26c
	// Line 261, Address: 0x1f02570, Func Offset: 0x280
	// Line 262, Address: 0x1f02578, Func Offset: 0x288
	// Line 264, Address: 0x1f02584, Func Offset: 0x294
	// Line 265, Address: 0x1f02588, Func Offset: 0x298
	// Func End, Address: 0x1f0259c, Func Offset: 0x2ac
}
