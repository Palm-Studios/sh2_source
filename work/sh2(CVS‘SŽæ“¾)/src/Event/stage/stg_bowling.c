...
typedef _AnimeInfo type_36[2];
typedef unsigned char type_37[164];
typedef fsFileIndex type_38[1];
typedef float type_39[4][2];
typedef fsFileIndex type_40[1];
typedef unsigned char type_41[14];
typedef _AnimeInfo type_42[24];
typedef _AnimeInfo type_43[5];
typedef unsigned char type_44[97];
typedef int type_45[6];
typedef unsigned int type_46[255];
...
typedef char type_56[4];
typedef DramaDemo_MessageTime type_57[3];
...
fsFileIndex data_demo_bp_edi_1_bp_edi_a_dds[1];
float demo_frame;
_anon7 game_flag;
fsFileIndex data_demo_bp_edi_2_bp_edi_h_dds[1];
fsFileIndex data_demo_bp_edi_2_bp_edi_c_dds[1];

int EvProgEddieAndLaura();
int EvProgEddieEatPizza();
int EvProgEddieEatPizzaAfter();
void EvStageInit();
...
// 
// Start address: 0x1f02030
int EvProgEddieEatPizza()
{
	int ret;
	float vec0[4];
	SubCharacter* scp;
	DramaDemo_PlayInfo pizza;
	// Line 188, Address: 0x1f02030, Func Offset: 0
	// Line 229, Address: 0x1f0203c, Func Offset: 0xc
	// Line 231, Address: 0x1f0206c, Func Offset: 0x3c
	// Line 232, Address: 0x1f0207c, Func Offset: 0x4c
	// Line 233, Address: 0x1f02088, Func Offset: 0x58
	// Line 234, Address: 0x1f0209c, Func Offset: 0x6c
	// Line 237, Address: 0x1f020b0, Func Offset: 0x80
	// Line 238, Address: 0x1f020c4, Func Offset: 0x94
	// Line 239, Address: 0x1f020d4, Func Offset: 0xa4
	// Line 240, Address: 0x1f02110, Func Offset: 0xe0
	// Line 241, Address: 0x1f0212c, Func Offset: 0xfc
	// Line 244, Address: 0x1f02134, Func Offset: 0x104
	// Line 245, Address: 0x1f02148, Func Offset: 0x118
	// Line 246, Address: 0x1f0215c, Func Offset: 0x12c
	// Line 247, Address: 0x1f0217c, Func Offset: 0x14c
	// Line 248, Address: 0x1f02184, Func Offset: 0x154
	// Line 249, Address: 0x1f021a0, Func Offset: 0x170
	// Line 251, Address: 0x1f021c0, Func Offset: 0x190
	// Line 252, Address: 0x1f021d0, Func Offset: 0x1a0
	// Line 254, Address: 0x1f021f4, Func Offset: 0x1c4
	// Line 255, Address: 0x1f02204, Func Offset: 0x1d4
	// Line 256, Address: 0x1f0222c, Func Offset: 0x1fc
	// Line 257, Address: 0x1f02254, Func Offset: 0x224
	// Line 258, Address: 0x1f02260, Func Offset: 0x230
	// Line 259, Address: 0x1f02274, Func Offset: 0x244
	// Line 260, Address: 0x1f0227c, Func Offset: 0x24c
	// Line 261, Address: 0x1f02288, Func Offset: 0x258
	// Line 263, Address: 0x1f02294, Func Offset: 0x264
	// Line 264, Address: 0x1f02298, Func Offset: 0x268
	// Func End, Address: 0x1f022ac, Func Offset: 0x27c
}
...
void EvRoomInit()
{
	...
	float vec[4];
	SubCharacter* scp;
	CharaData_DemoList lane_chara[4];
...
// 
// Start address: 0x1f026a0
int EvBgmControl()
{
	// Line 386, Address: 0x1f026a0, Func Offset: 0
	// Line 388, Address: 0x1f026b8, Func Offset: 0x18
	// Func End, Address: 0x1f026c0, Func Offset: 0x20
	// Line 251, Address: 0x1f026a0, Func Offset: 0
	// Line 252, Address: 0x1f026a8, Func Offset: 0x8
	// Line 253, Address: 0x1f026b4, Func Offset: 0x14
	// Line 254, Address: 0x1f026b8, Func Offset: 0x18
	// Func End, Address: 0x1f026c8, Func Offset: 0x28
}
