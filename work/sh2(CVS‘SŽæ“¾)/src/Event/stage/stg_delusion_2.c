...
typedef Item_List type_29[9];
typedef _AnimeInfo type_30[33];
...
typedef unsigned char type_37[144];
typedef Enemy_List type_38[3];
typedef float type_39[4];
typedef _AnimeInfo type_40[5];
typedef unsigned char type_41[97];
typedef unsigned int type_42[255];
...
_anon7 game_flag;
float demo_frame;
fsFileIndex data_demo_jump1_hll_jms_anm[1];
char MemShare_gp_data_buf[0];
fsFileIndex data_demo_jump1_jump1_dds[1];
_SH2_SYS Sh2sys;
