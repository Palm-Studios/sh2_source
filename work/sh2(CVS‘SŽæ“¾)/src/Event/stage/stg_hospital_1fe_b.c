...
typedef CharaData_DemoList type_8[3];
...
typedef _AnimeInfo type_15[30];
typedef char type_16[4];
typedef fsFileIndex type_17[1];
typedef Event_List type_18[32];
...
typedef CharaData_DemoList type_24[2];
...
typedef Model_List type_47[2];
typedef float type_48[4];
typedef _AnimeInfo type_49[24];
typedef unsigned char type_50[338];
typedef _AnimeInfo type_51[2];
...
fsFileIndex data_demo_hp_ele_hp_ele_dds[1];
_anon1 game_flag;
...
// 
// Start address: 0x1f02010
int EvProgUseHospitalEnterKey()
{
	// Line 131, Address: 0x1f02010, Func Offset: 0
	// Line 132, Address: 0x1f02018, Func Offset: 0x8
	// Line 135, Address: 0x1f02048, Func Offset: 0x38
	// Func End, Address: 0x1f02058, Func Offset: 0x48
}
