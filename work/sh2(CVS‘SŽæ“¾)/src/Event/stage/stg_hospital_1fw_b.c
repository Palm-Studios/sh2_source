...
typedef char type_1[0];
typedef Enemy_List type_3[1];
typedef unsigned char type_4[97];
typedef CharaData_DemoList type_5[6];
typedef Item_List type_6[8];
...
typedef CharaData_DemoList type_16[5];
...
typedef unsigned char type_24[278];
...
typedef unsigned char type_32[14];
...
unsigned char ev_pos[278];
Event_List ev_list[25];
Item_List gi_list[8];
int(*ev_prog)()[5];
...
fsFileIndex data_demo_lau_damasu_m_lau_damasu_1_dds[1];
_anon1 game_flag;
fsFileIndex data_chr_ike_ike_anm[1];
shPlayerWork sh2jms;
char* dds_adr;
fsFileIndex data_demo_go_to_ura_go_to_ura_a_dds[1];
fsFileIndex data_demo_lau_damasu2_lau_damasu_2_dds[1];
float demo_frame;
fsFileIndex data_demo_go_to_ura_hll_jms_anm[1];
fsFileIndex data_demo_go_to_ura_go_to_ura_b_dds[1];
_SH2_SYS Sh2sys;

int EvProgLauraDeceive2nd();
int EvProgLauraDeceive3rd();
int EvProgHospitalBack1st();
int EvProgHospitalBack2nd();
void EvRoomInit();
...
int EvProgLauraDeceive2nd()
{
	DramaDemo_PlayInfo deceive_2;
	CharaData_DemoList chara_data[6];
...
int EvProgLauraDeceive3rd()
{
	float vec[4][6];
	float door[4][2];
	<unknown fundamental type (0xa510)>* iketani_adr;
	DramaDemo_PlayInfo deceive_3;
...
// 
// Start address: 0x1f02400
int EvProgHospitalBack2nd()
{
	<unknown fundamental type (0xa510)>* anim_adr;
	DramaDemo_PlayInfo info;
	// Line 333, Address: 0x1f02400, Func Offset: 0
	// Line 342, Address: 0x1f02408, Func Offset: 0x8
	// Line 344, Address: 0x1f02438, Func Offset: 0x38
	// Line 345, Address: 0x1f02450, Func Offset: 0x50
	// Line 347, Address: 0x1f0246c, Func Offset: 0x6c
	// Line 348, Address: 0x1f0247c, Func Offset: 0x7c
	// Line 349, Address: 0x1f0249c, Func Offset: 0x9c
	// Line 350, Address: 0x1f024b0, Func Offset: 0xb0
	// Line 351, Address: 0x1f024b8, Func Offset: 0xb8
	// Line 352, Address: 0x1f024c4, Func Offset: 0xc4
	// Line 353, Address: 0x1f024cc, Func Offset: 0xcc
	// Line 357, Address: 0x1f024e0, Func Offset: 0xe0
	// Line 358, Address: 0x1f024ec, Func Offset: 0xec
	// Line 359, Address: 0x1f02528, Func Offset: 0x128
	// Line 360, Address: 0x1f02554, Func Offset: 0x154
	// Line 363, Address: 0x1f0255c, Func Offset: 0x15c
	// Line 364, Address: 0x1f02564, Func Offset: 0x164
	// Line 365, Address: 0x1f02584, Func Offset: 0x184
	// Line 366, Address: 0x1f02598, Func Offset: 0x198
	// Line 367, Address: 0x1f025a0, Func Offset: 0x1a0
	// Line 370, Address: 0x1f025d0, Func Offset: 0x1d0
	// Line 371, Address: 0x1f025dc, Func Offset: 0x1dc
	// Line 373, Address: 0x1f025e8, Func Offset: 0x1e8
	// Line 374, Address: 0x1f025ec, Func Offset: 0x1ec
	// Func End, Address: 0x1f025fc, Func Offset: 0x1fc
}

// 
// Start address: 0x1f02600
void EvRoomInit()
{
	int room;
	// Line 381, Address: 0x1f02600, Func Offset: 0
	// Line 384, Address: 0x1f02608, Func Offset: 0x8
	// Line 385, Address: 0x1f02610, Func Offset: 0x10
	// Line 386, Address: 0x1f0261c, Func Offset: 0x1c
	// Line 387, Address: 0x1f02634, Func Offset: 0x34
	// Line 388, Address: 0x1f02640, Func Offset: 0x40
	// Line 389, Address: 0x1f0264c, Func Offset: 0x4c
	// Line 390, Address: 0x1f02654, Func Offset: 0x54
	// Line 392, Address: 0x1f0265c, Func Offset: 0x5c
	// Line 393, Address: 0x1f0266c, Func Offset: 0x6c
	// Func End, Address: 0x1f0267c, Func Offset: 0x7c
	// Line 311, Address: 0x1f02600, Func Offset: 0
	// Line 312, Address: 0x1f02608, Func Offset: 0x8
	// Line 313, Address: 0x1f02618, Func Offset: 0x18
	// Func End, Address: 0x1f02628, Func Offset: 0x28
}

// 
// Start address: 0x1f02680
void EvSoundCallAfterLoad()
{
	int room;
	// Line 398, Address: 0x1f02680, Func Offset: 0
	// Line 401, Address: 0x1f02688, Func Offset: 0x8
	// Line 402, Address: 0x1f02690, Func Offset: 0x10
	// Line 403, Address: 0x1f0269c, Func Offset: 0x1c
	// Line 404, Address: 0x1f026b4, Func Offset: 0x34
	// Line 405, Address: 0x1f026d0, Func Offset: 0x50
	// Line 406, Address: 0x1f026d8, Func Offset: 0x58
	// Line 407, Address: 0x1f026e8, Func Offset: 0x68
	// Line 410, Address: 0x1f02700, Func Offset: 0x80
	// Func End, Address: 0x1f02710, Func Offset: 0x90
}
...
// 
// Start address: 0x1f028b0
int EvBgmControl()
{
	// Line 457, Address: 0x1f028b0, Func Offset: 0
	// Line 458, Address: 0x1f028b8, Func Offset: 0x8
	// Line 459, Address: 0x1f028d0, Func Offset: 0x20
	// Line 460, Address: 0x1f028f0, Func Offset: 0x40
	// Line 462, Address: 0x1f02910, Func Offset: 0x60
	// Line 463, Address: 0x1f02914, Func Offset: 0x64
	// Func End, Address: 0x1f02924, Func Offset: 0x74
}
