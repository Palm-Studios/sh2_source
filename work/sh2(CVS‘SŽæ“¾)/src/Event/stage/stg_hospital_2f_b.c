...
typedef Enemy_List type_3[4];
typedef _AnimeInfo type_4[33];
...
typedef unsigned char type_32[242];
typedef char type_33[0];
...
typedef CharaData_DemoList type_44[5];
typedef Model_List type_45[4];
typedef _AnimeInfo type_46[33];
typedef unsigned char type_47[2];
typedef float type_48[4];
typedef unsigned char type_49[2];
typedef _AnimeInfo type_50[24];
typedef _AnimeInfo type_51[18];
typedef unsigned char type_52[14];
typedef Event_List type_53[22];
...
fsFileIndex data_demo_reizouko_a_reizouko_jms_dds[1];

int EvProgRefrigeratorOpen();
int EvProgRefrigeratorNotOpen();
...
int EvProgRefrigeratorOpen()
{
	int ret;
	SubCharacter* scp;
	DramaDemo_PlayInfo refrigerator_b;
	CharaData_DemoList chara_data_2[5];
...
{
	int ret;
	DramaDemo_PlayInfo refrigerator_a;
	CharaData_DemoList chara_data_1[3];
...
// 
// Start address: 0x1f026c0
void EvAllTimeFunc()
{
	// Line 393, Address: 0x1f026c0, Func Offset: 0
	// Line 401, Address: 0x1f026c8, Func Offset: 0x8
	// Line 403, Address: 0x1f026d0, Func Offset: 0x10
	// Line 404, Address: 0x1f026dc, Func Offset: 0x1c
	// Line 405, Address: 0x1f026f4, Func Offset: 0x34
	// Line 407, Address: 0x1f02710, Func Offset: 0x50
	// Line 409, Address: 0x1f02724, Func Offset: 0x64
	// Line 411, Address: 0x1f0272c, Func Offset: 0x6c
	// Func End, Address: 0x1f0273c, Func Offset: 0x7c
	// Line 335, Address: 0x1f026c0, Func Offset: 0
	// Func End, Address: 0x1f026c8, Func Offset: 0x8
}
