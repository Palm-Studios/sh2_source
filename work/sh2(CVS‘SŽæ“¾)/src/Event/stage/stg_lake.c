...
typedef Model_List type_27[2];
typedef _AnimeInfo type_28[4];
typedef fsFileIndex type_29[1];
typedef float type_30[4];
typedef unsigned char type_31[97];
typedef _AnimeInfo type_32[33];
typedef unsigned char type_33[104];
typedef unsigned int type_34[255];
typedef _AnimeInfo type_35[11];
typedef _AnimeInfo type_36[30];
typedef unsigned int type_37[32];
typedef unsigned char type_38[4];
typedef CharaData_DemoList type_39[4];
typedef char type_40[4];
typedef char type_41[4];
typedef CharaData_DemoList type_42[3];
typedef char type_43[4];
typedef unsigned char type_44[2];
typedef char type_45[4];
typedef unsigned char type_46[20];
typedef _AnimeInfo type_47[17];
typedef float type_48[4];
typedef char type_49[4];
typedef _AnimeInfo type_50[34];
...
_AnimeInfo pjames_stage_anim[4];
unsigned char ev_pos[104];
Event_List ev_list[9];
int(*ev_prog)()[5];
...
fsFileIndex data_demo_fukatsu_d_end_rebirth_d_dds[1];
_anon6 game_flag;
fsFileIndex data_demo_boat2_boat2_dds[1];
fsFileIndex data_demo_boat1_boat1_dds[1];

int EvProgEmbarkBoat();
int EvProgDisembarkBoat();
int EvProgGetLittleMermaid();
int EvProgEndRebirth();
...
// 
// Start address: 0x1f02130
int EvProgEndRebirth()
{
	DramaDemo_PlayInfo info;
	CharaData_DemoList chara_data[4];
	// Line 128, Address: 0x1f02130, Func Offset: 0
	// Line 130, Address: 0x1f02148, Func Offset: 0x18
	// Func End, Address: 0x1f02150, Func Offset: 0x20
	// Line 177, Address: 0x1f02130, Func Offset: 0
	// Line 208, Address: 0x1f02138, Func Offset: 0x8
	// Line 210, Address: 0x1f02168, Func Offset: 0x38
	// Line 211, Address: 0x1f02180, Func Offset: 0x50
	// Line 212, Address: 0x1f02194, Func Offset: 0x64
	// Line 213, Address: 0x1f021a4, Func Offset: 0x74
	// Line 214, Address: 0x1f021b0, Func Offset: 0x80
	// Line 215, Address: 0x1f021c4, Func Offset: 0x94
	// Line 219, Address: 0x1f021d8, Func Offset: 0xa8
	// Line 220, Address: 0x1f02204, Func Offset: 0xd4
	// Line 223, Address: 0x1f0220c, Func Offset: 0xdc
	// Line 224, Address: 0x1f02218, Func Offset: 0xe8
	// Line 225, Address: 0x1f02224, Func Offset: 0xf4
	// Line 226, Address: 0x1f02230, Func Offset: 0x100
	// Line 227, Address: 0x1f0223c, Func Offset: 0x10c
	// Line 229, Address: 0x1f02248, Func Offset: 0x118
	// Line 230, Address: 0x1f0224c, Func Offset: 0x11c
	// Func End, Address: 0x1f0225c, Func Offset: 0x12c
}
...
void EvRoomInit()
{
	CharaData_DemoList before_data[3];
