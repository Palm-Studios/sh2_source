...
typedef _AnimeInfo type_2[11];
typedef unsigned char type_3[20];
typedef _AnimeInfo type_4[30];
typedef CharaData_DemoList type_5[4];
...
typedef _AnimeInfo type_20[17];
typedef fsFileIndex type_21[1];
typedef unsigned char type_22[86];
...
typedef unsigned char type_29[69];
...
typedef _AnimeInfo type_43[24];
typedef Event_List type_44[7];
typedef int(*type_45)()[4];
typedef _AnimeInfo type_46[5];
typedef unsigned char type_47[97];
typedef float type_48[4];
typedef _AnimeInfo type_49[2];
...
Event_List ev_list[7];
int(*ev_prog)()[4];
Stage_Data stage_to_heaven;
<unknown fundamental type (0xa510)>* jms_anim_c_adr;
<unknown fundamental type (0xa510)>* mar_anim_c_adr;
char* dds_a_adr;
char* dds_b_adr;
char* dds_c_adr;
shPlayerWork sh2jms;
...
int ev_p_step;
_anon3 game_flag;
fsFileIndex data_demo_gekijou_c_gekijou_c_dds[1];
fsFileIndex data_demo_gekijou_a_gekijou_b_dds[1];
fsFileIndex data_demo_gekijou_a_gekijou_a_dds[1];
fsFileIndex data_demo_gekijou_c_lll_mar_anm[1];
fsFileIndex data_demo_gekijou_c_lll_jms_anm[1];

int EvProgLauraWentSideRoad();
int EvProgMariaUnlockHeaven();
int EvProgJamesCantGo();
...
int EvProgMariaUnlockHeaven()
{
	...
	// Line 144, Address: 0x1f02070, Func Offset: 0
	// Line 165, Address: 0x1f02078, Func Offset: 0x8
	// Line 167, Address: 0x1f020a8, Func Offset: 0x38
	// Line 168, Address: 0x1f020b8, Func Offset: 0x48
	// Line 169, Address: 0x1f020c4, Func Offset: 0x54
	// Line 170, Address: 0x1f020d8, Func Offset: 0x68
	// Line 173, Address: 0x1f020ec, Func Offset: 0x7c
	// Line 174, Address: 0x1f02118, Func Offset: 0xa8
	// Line 177, Address: 0x1f02120, Func Offset: 0xb0
	// Line 178, Address: 0x1f02134, Func Offset: 0xc4
	// Line 179, Address: 0x1f02148, Func Offset: 0xd8
	// Line 180, Address: 0x1f0215c, Func Offset: 0xec
	// Line 181, Address: 0x1f02170, Func Offset: 0x100
	// Line 182, Address: 0x1f02184, Func Offset: 0x114
	// Line 183, Address: 0x1f02190, Func Offset: 0x120
	// Line 184, Address: 0x1f021a4, Func Offset: 0x134
	// Line 185, Address: 0x1f021b0, Func Offset: 0x140
	// Line 186, Address: 0x1f021c0, Func Offset: 0x150
	// Line 187, Address: 0x1f021cc, Func Offset: 0x15c
	// Line 188, Address: 0x1f021d8, Func Offset: 0x168
	// Line 189, Address: 0x1f021e4, Func Offset: 0x174
	// Line 190, Address: 0x1f021e8, Func Offset: 0x178
	// Line 191, Address: 0x1f021f4, Func Offset: 0x184
	// Line 192, Address: 0x1f021f8, Func Offset: 0x188
	// Line 193, Address: 0x1f0220c, Func Offset: 0x19c
	// Line 194, Address: 0x1f02214, Func Offset: 0x1a4
	// Line 195, Address: 0x1f0221c, Func Offset: 0x1ac
	// Line 196, Address: 0x1f02228, Func Offset: 0x1b8
	// Line 197, Address: 0x1f02234, Func Offset: 0x1c4
	// Line 199, Address: 0x1f02240, Func Offset: 0x1d0
	// Line 200, Address: 0x1f02244, Func Offset: 0x1d4
	// Func End, Address: 0x1f02254, Func Offset: 0x1e4
}
