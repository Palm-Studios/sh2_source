...
typedef int(*type_24)();
typedef void(*type_110)(SubCharacter*);
typedef void(*type_115)(SubCharacter*);
...
typedef Item_List type_5[18];
typedef Q_WORDDATA type_6[10];
typedef Q_WORDDATA type_7[8];
...
typedef _CL_HITPOLY_PLANE type_19[14];
typedef _CL_HITPOLY_PLANE type_20[10];
typedef Q_WORDDATA type_21[2];
typedef _CL_HITPOLY_PLANE type_22[4];
typedef _CL_HITPOLY_PLANE type_23[8];
typedef Q_WORDDATA type_25[2];
typedef Q_WORDDATA type_26[54];
typedef Q_WORDDATA type_27[2];
typedef _AnimeInfo type_28[21];
typedef _AnimeInfo type_29[33];
typedef unsigned int type_30[2];
typedef Q_WORDDATA type_31[2];
typedef unsigned short type_32[11];
typedef Q_WORDDATA type_33[54];
typedef Q_WORDDATA type_34[2];
typedef Q_WORDDATA type_35[5];
typedef unsigned char type_36[600];
typedef Q_WORDDATA type_37[2];
typedef Q_WORDDATA type_38[2];
typedef float type_39[4][16];
...
typedef shAttackInfo type_86[66];
typedef float type_87[4];
typedef float type_88[4];
typedef _AnimeInfo type_89[17];
typedef unsigned int type_90[24];
typedef short type_91[8];
typedef float type_92[4][4];
typedef PAD_INFO type_93[10];
typedef unsigned char type_94[14];
typedef char type_95[16];
typedef unsigned int type_96[3];
typedef unsigned long type_97[2];
typedef unsigned int type_98[3];
typedef Event_List type_99[48];
typedef unsigned short type_100[8];
typedef _CL_HITPOLY_PLANE type_101[2];
typedef _CL_HITPOLY_PLANE type_102[10];
typedef _CL_HITPOLY_PLANE type_103[2];
typedef float type_104[2];
typedef _CL_HITPOLY_PLANE type_105[7];
typedef Q_WORDDATA type_106[8];
typedef float type_107[4];
typedef _AnimeInfo type_108[17];
typedef float type_109[4][2];
typedef unsigned char type_111[4];
typedef CharaData_DemoList type_112[3];
typedef unsigned char type_113[4];
typedef unsigned char type_114[69];
typedef int type_116[129];
typedef unsigned char type_117[4];
typedef _AnimeInfo type_118[33];
typedef CharaData_DemoList type_119[4];
typedef _anon13 type_120[3];
typedef Q_WORDDATA type_121[8];
typedef fsFileIndex type_122[1];
typedef unsigned char type_123[2];
typedef shGsDrawEnv type_124[3];
typedef fsFileIndex type_125[1];
typedef unsigned char type_126[2];
typedef shGsStencilDrawEnv type_127[3];
typedef shGsTinyDrawEnv type_128[6];
typedef Q_WORDDATA type_129[10];
typedef Q_WORDDATA type_130[10];
typedef float type_131[4];
typedef Q_WORDDATA type_132[10];
typedef _AnimeInfo type_133[24];
typedef Model_List type_134[72];
...
Event_List ev_list[48];
Item_List gi_list[18];
_CL_HITPOLY_PLANE clActWallList_cb11[8];
_CL_HITPOLY_PLANE clActWallList_cb12[7];
_CL_HITPOLY_PLANE clActWallList_cb18[4];
_CL_HITPOLY_PLANE clActWallList_cb19[10];
_CL_HITPOLY_PLANE clActWallList_cb20[10];
_CL_HITPOLY_PLANE clActWallList_cb21[2];
_CL_HITPOLY_PLANE clActWallList_cb49[14];
_CL_HITPOLY_PLANE clActWallList_cb52[2];
int(*ev_prog)()[10];
Model_List mdl_list[72];
Enemy_List en_list[108];
_anon3 SpecialDrawFunctions;
Stage_Data stage_town_east;
<unknown fundamental type (0xa510)>* anim_adr;
char* dds_adr[4];
<unknown fundamental type (0xa510)>* wp_mdl;
<unknown fundamental type (0xa510)>* wp_anm;
int sig_timer_b;
int sig_timer_b2;
int sig_num_a;
int sig_num_b;
...
fsFileIndex data_demo_machi_machi_dds[1];
...
float CB_Tonnel[4][16];
Q_WORDDATA ScissorVertex[54];
Q_WORDDATA OutputVertex[54];
shGsAllEnv shGs_AllEnv;

int EvProgShadowOfSomenthing();
int EvProgSandersBack();
int EvProgFirstMonsterStart();
int EvProgFirstMonsterCorpse();
int EvProgFirstMonsterEnd();
int EvProgBloodSwamp();
int EvProgGetApartGateKey();
int EvProgUseApartGateKey();
int EvProgLookMemoFalled();
void EvStageInit();
int EvCharaDataClear();
void EvRoomInit();
void EvAllTimeFunc();
int EvBgmControl();
void EvLockSetCb46(int* list);
void EvCorpseSetCb18(int* list);
void EvCorpseSetCb26();
void EvWallSetCb19(int* list);
void EvWallSetCb20(int* list);
void EvWallSetCb21(int* list);
void EvWallSetCb49(int* list);
void EvWallSetCb52(int* list);
void EvSignalControlCb27(int* list);
void EvSignalControlCb28(int* list);
void EvSignalControlCb29(int* list);
void EvSignalControlCb35(int* list);
void EvSignalControlCb36(int* list);
void EvSignalControlCb37(int* list);
void EvTapeSetCb11(int* list);
void EvTapeSetCb12(int* list);
float LinearTrim(float Yen, float Yst, float Xen, float Xst, float Parm);
void CB_1stMoster_FogHosei();
void CB_1stMonster_Filter();
void Draw_CB_Tonnel();
void Monster1st_Look(void* sp, float* ambient);
...
// 
// Start address: 0x1f02260
int EvProgSandersBack()
{
	float pos[4];
	// Line 549, Address: 0x1f02260, Func Offset: 0
	// Line 552, Address: 0x1f02268, Func Offset: 0x8
	// Line 555, Address: 0x1f022b0, Func Offset: 0x50
	// Line 556, Address: 0x1f022c4, Func Offset: 0x64
	// Line 557, Address: 0x1f022d0, Func Offset: 0x70
	// Line 560, Address: 0x1f022e4, Func Offset: 0x84
	// Line 561, Address: 0x1f022f8, Func Offset: 0x98
	// Line 562, Address: 0x1f0230c, Func Offset: 0xac
	// Line 565, Address: 0x1f02314, Func Offset: 0xb4
	// Line 566, Address: 0x1f02338, Func Offset: 0xd8
	// Line 567, Address: 0x1f02344, Func Offset: 0xe4
	// Line 568, Address: 0x1f02350, Func Offset: 0xf0
	// Line 569, Address: 0x1f02358, Func Offset: 0xf8
	// Line 572, Address: 0x1f02368, Func Offset: 0x108
	// Line 573, Address: 0x1f02378, Func Offset: 0x118
	// Line 574, Address: 0x1f0239c, Func Offset: 0x13c
	// Line 577, Address: 0x1f023a4, Func Offset: 0x144
	// Line 578, Address: 0x1f023b8, Func Offset: 0x158
	// Line 580, Address: 0x1f023c4, Func Offset: 0x164
	// Line 581, Address: 0x1f023c8, Func Offset: 0x168
	// Func End, Address: 0x1f023d8, Func Offset: 0x178
	// Line 206, Address: 0x1f02260, Func Offset: 0
	// Line 227, Address: 0x1f0226c, Func Offset: 0xc
	// Line 229, Address: 0x1f0229c, Func Offset: 0x3c
	// Line 230, Address: 0x1f022ac, Func Offset: 0x4c
	// Line 231, Address: 0x1f022c0, Func Offset: 0x60
	// Line 233, Address: 0x1f022e0, Func Offset: 0x80
	// Line 234, Address: 0x1f022e8, Func Offset: 0x88
	// Line 235, Address: 0x1f022fc, Func Offset: 0x9c
	// Line 236, Address: 0x1f02310, Func Offset: 0xb0
	// Line 237, Address: 0x1f02320, Func Offset: 0xc0
	// Line 239, Address: 0x1f0233c, Func Offset: 0xdc
	// Line 240, Address: 0x1f02344, Func Offset: 0xe4
	// Line 243, Address: 0x1f02358, Func Offset: 0xf8
	// Line 244, Address: 0x1f02384, Func Offset: 0x124
	// Line 247, Address: 0x1f0238c, Func Offset: 0x12c
	// Line 248, Address: 0x1f023a0, Func Offset: 0x140
	// Line 250, Address: 0x1f023c0, Func Offset: 0x160
	// Line 251, Address: 0x1f023c8, Func Offset: 0x168
	// Line 252, Address: 0x1f023dc, Func Offset: 0x17c
	// Line 253, Address: 0x1f023f0, Func Offset: 0x190
	// Line 254, Address: 0x1f02404, Func Offset: 0x1a4
	// Line 255, Address: 0x1f02410, Func Offset: 0x1b0
	// Line 256, Address: 0x1f02424, Func Offset: 0x1c4
	// Line 257, Address: 0x1f02430, Func Offset: 0x1d0
	// Line 258, Address: 0x1f02444, Func Offset: 0x1e4
	// Line 259, Address: 0x1f02454, Func Offset: 0x1f4
	// Line 261, Address: 0x1f02470, Func Offset: 0x210
	// Line 262, Address: 0x1f02478, Func Offset: 0x218
	// Line 263, Address: 0x1f02484, Func Offset: 0x224
	// Line 264, Address: 0x1f02490, Func Offset: 0x230
	// Line 265, Address: 0x1f0249c, Func Offset: 0x23c
	// Line 266, Address: 0x1f024a0, Func Offset: 0x240
	// Line 267, Address: 0x1f024ac, Func Offset: 0x24c
	// Line 268, Address: 0x1f024b0, Func Offset: 0x250
	// Line 269, Address: 0x1f024bc, Func Offset: 0x25c
	// Line 271, Address: 0x1f024c8, Func Offset: 0x268
	// Line 272, Address: 0x1f024cc, Func Offset: 0x26c
	// Func End, Address: 0x1f024e0, Func Offset: 0x280
	// Line 236, Address: 0x1f02260, Func Offset: 0
	// Line 238, Address: 0x1f02278, Func Offset: 0x18
	// Func End, Address: 0x1f02280, Func Offset: 0x20
}
...
// 
// Start address: 0x1f02650
int EvProgFirstMonsterCorpse()
{
	SubCharacter* scp;
	float jms_rot;
	float jms_pos[4];
	DramaDemo_PlayInfo info_a;
	// Line 664, Address: 0x1f02650, Func Offset: 0
	// Line 685, Address: 0x1f02658, Func Offset: 0x8
	// Line 687, Address: 0x1f02688, Func Offset: 0x38
	// Line 688, Address: 0x1f02690, Func Offset: 0x40
	// Line 689, Address: 0x1f026a0, Func Offset: 0x50
	// Line 690, Address: 0x1f026ac, Func Offset: 0x5c
	// Line 691, Address: 0x1f026c0, Func Offset: 0x70
	// Line 693, Address: 0x1f026e8, Func Offset: 0x98
	// Line 694, Address: 0x1f026f8, Func Offset: 0xa8
	// Line 695, Address: 0x1f02708, Func Offset: 0xb8
	// Line 696, Address: 0x1f02720, Func Offset: 0xd0
	// Line 700, Address: 0x1f02734, Func Offset: 0xe4
	// Line 701, Address: 0x1f02760, Func Offset: 0x110
	// Line 704, Address: 0x1f02768, Func Offset: 0x118
	// Line 705, Address: 0x1f02774, Func Offset: 0x124
	// Line 706, Address: 0x1f02788, Func Offset: 0x138
	// Line 707, Address: 0x1f0279c, Func Offset: 0x14c
	// Line 708, Address: 0x1f027ac, Func Offset: 0x15c
	// Line 709, Address: 0x1f027b8, Func Offset: 0x168
	// Line 711, Address: 0x1f027e0, Func Offset: 0x190
	// Line 712, Address: 0x1f02800, Func Offset: 0x1b0
	// Line 713, Address: 0x1f02814, Func Offset: 0x1c4
	// Line 714, Address: 0x1f0281c, Func Offset: 0x1cc
	// Line 715, Address: 0x1f02828, Func Offset: 0x1d8
	// Line 716, Address: 0x1f02834, Func Offset: 0x1e4
	// Line 718, Address: 0x1f02840, Func Offset: 0x1f0
	// Line 719, Address: 0x1f02844, Func Offset: 0x1f4
	// Func End, Address: 0x1f02854, Func Offset: 0x204
}

// 
// Start address: 0x1f02860
int EvProgFirstMonsterEnd()
{
	CharaData_DemoList enemy_list[3];
	float jms_rot;
	float jms_pos[4];
	DramaDemo_PlayInfo info_b;
	// Line 725, Address: 0x1f02860, Func Offset: 0
	// Line 757, Address: 0x1f02868, Func Offset: 0x8
	// Line 759, Address: 0x1f02898, Func Offset: 0x38
	// Line 760, Address: 0x1f028a8, Func Offset: 0x48
	// Line 761, Address: 0x1f028b4, Func Offset: 0x54
	// Line 762, Address: 0x1f028c8, Func Offset: 0x68
	// Line 766, Address: 0x1f028dc, Func Offset: 0x7c
	// Line 767, Address: 0x1f02908, Func Offset: 0xa8
	// Line 770, Address: 0x1f02910, Func Offset: 0xb0
	// Line 771, Address: 0x1f0291c, Func Offset: 0xbc
	// Line 772, Address: 0x1f02928, Func Offset: 0xc8
	// Line 773, Address: 0x1f02948, Func Offset: 0xe8
	// Line 774, Address: 0x1f0295c, Func Offset: 0xfc
	// Line 775, Address: 0x1f02964, Func Offset: 0x104
	// Line 776, Address: 0x1f02970, Func Offset: 0x110
	// Line 777, Address: 0x1f0297c, Func Offset: 0x11c
	// Line 778, Address: 0x1f02984, Func Offset: 0x124
	// Line 779, Address: 0x1f02994, Func Offset: 0x134
	// Line 781, Address: 0x1f029a0, Func Offset: 0x140
	// Line 782, Address: 0x1f029a4, Func Offset: 0x144
	// Func End, Address: 0x1f029b4, Func Offset: 0x154
}
...
// 
// Start address: 0x1f02a20
int EvProgGetApartGateKey()
{
	// Line 800, Address: 0x1f02a20, Func Offset: 0
	// Line 801, Address: 0x1f02a28, Func Offset: 0x8
	// Line 803, Address: 0x1f02a38, Func Offset: 0x18
	// Func End, Address: 0x1f02a48, Func Offset: 0x28
}

// 
// Start address: 0x1f02a50
int EvProgUseApartGateKey()
{
	// Line 808, Address: 0x1f02a50, Func Offset: 0
	// Line 809, Address: 0x1f02a58, Func Offset: 0x8
	// Line 812, Address: 0x1f02a88, Func Offset: 0x38
	// Func End, Address: 0x1f02a98, Func Offset: 0x48
}

// 
// Start address: 0x1f02aa0
int EvProgLookMemoFalled()
{
	int i;
	// Line 817, Address: 0x1f02aa0, Func Offset: 0
	// Line 820, Address: 0x1f02aa8, Func Offset: 0x8
	// Line 822, Address: 0x1f02afc, Func Offset: 0x5c
	// Line 823, Address: 0x1f02b0c, Func Offset: 0x6c
	// Line 824, Address: 0x1f02b18, Func Offset: 0x78
	// Line 828, Address: 0x1f02b2c, Func Offset: 0x8c
	// Line 829, Address: 0x1f02b3c, Func Offset: 0x9c
	// Line 830, Address: 0x1f02b44, Func Offset: 0xa4
	// Line 831, Address: 0x1f02b58, Func Offset: 0xb8
	// Line 833, Address: 0x1f02b60, Func Offset: 0xc0
	// Line 834, Address: 0x1f02b70, Func Offset: 0xd0
	// Line 835, Address: 0x1f02b80, Func Offset: 0xe0
	// Line 836, Address: 0x1f02b98, Func Offset: 0xf8
	// Line 837, Address: 0x1f02ba8, Func Offset: 0x108
	// Line 838, Address: 0x1f02bc4, Func Offset: 0x124
	// Line 839, Address: 0x1f02bd8, Func Offset: 0x138
	// Line 840, Address: 0x1f02be0, Func Offset: 0x140
	// Line 845, Address: 0x1f02c38, Func Offset: 0x198
	// Line 846, Address: 0x1f02c54, Func Offset: 0x1b4
	// Line 849, Address: 0x1f02c68, Func Offset: 0x1c8
	// Line 852, Address: 0x1f02c70, Func Offset: 0x1d0
	// Line 853, Address: 0x1f02c88, Func Offset: 0x1e8
	// Line 854, Address: 0x1f02c9c, Func Offset: 0x1fc
	// Line 855, Address: 0x1f02ca4, Func Offset: 0x204
	// Line 857, Address: 0x1f02cb8, Func Offset: 0x218
	// Line 859, Address: 0x1f02ccc, Func Offset: 0x22c
	// Line 860, Address: 0x1f02cd0, Func Offset: 0x230
	// Line 861, Address: 0x1f02ce8, Func Offset: 0x248
	// Line 862, Address: 0x1f02cfc, Func Offset: 0x25c
	// Line 863, Address: 0x1f02d14, Func Offset: 0x274
	// Line 864, Address: 0x1f02d28, Func Offset: 0x288
	// Line 865, Address: 0x1f02d40, Func Offset: 0x2a0
	// Line 866, Address: 0x1f02d54, Func Offset: 0x2b4
	// Line 867, Address: 0x1f02d6c, Func Offset: 0x2cc
	// Line 868, Address: 0x1f02d80, Func Offset: 0x2e0
	// Line 869, Address: 0x1f02d98, Func Offset: 0x2f8
	// Line 870, Address: 0x1f02dac, Func Offset: 0x30c
	// Line 871, Address: 0x1f02dc4, Func Offset: 0x324
	// Line 872, Address: 0x1f02dd8, Func Offset: 0x338
	// Line 873, Address: 0x1f02de8, Func Offset: 0x348
	// Line 874, Address: 0x1f02dfc, Func Offset: 0x35c
	// Line 876, Address: 0x1f02e04, Func Offset: 0x364
	// Line 877, Address: 0x1f02e14, Func Offset: 0x374
	// Line 882, Address: 0x1f02e28, Func Offset: 0x388
	// Line 883, Address: 0x1f02e50, Func Offset: 0x3b0
	// Line 886, Address: 0x1f02e64, Func Offset: 0x3c4
	// Line 887, Address: 0x1f02e68, Func Offset: 0x3c8
	// Line 888, Address: 0x1f02e7c, Func Offset: 0x3dc
	// Line 889, Address: 0x1f02ebc, Func Offset: 0x41c
	// Line 890, Address: 0x1f02ed0, Func Offset: 0x430
	// Line 892, Address: 0x1f02edc, Func Offset: 0x43c
	// Line 893, Address: 0x1f02ee0, Func Offset: 0x440
	// Func End, Address: 0x1f02ef0, Func Offset: 0x450
}

// 
// Start address: 0x1f02ef0
void EvStageInit()
{
	// Line 899, Address: 0x1f02ef0, Func Offset: 0
	// Line 900, Address: 0x1f02f08, Func Offset: 0x18
	// Line 901, Address: 0x1f02f20, Func Offset: 0x30
	// Line 902, Address: 0x1f02f38, Func Offset: 0x48
	// Line 903, Address: 0x1f02f50, Func Offset: 0x60
	// Line 904, Address: 0x1f02f68, Func Offset: 0x78
	// Line 905, Address: 0x1f02f7c, Func Offset: 0x8c
	// Func End, Address: 0x1f02f84, Func Offset: 0x94
}
...
// 
// Start address: 0x1f02fb0
void EvRoomInit()
{
	CharaData_DemoList chara[4];
	// Line 918, Address: 0x1f02fb0, Func Offset: 0
	// Line 932, Address: 0x1f02fb8, Func Offset: 0x8
	// Line 933, Address: 0x1f02fd0, Func Offset: 0x20
	// Line 934, Address: 0x1f02fe4, Func Offset: 0x34
	// Line 936, Address: 0x1f03000, Func Offset: 0x50
	// Line 938, Address: 0x1f0301c, Func Offset: 0x6c
	// Line 940, Address: 0x1f03038, Func Offset: 0x88
	// Line 942, Address: 0x1f03054, Func Offset: 0xa4
	// Line 944, Address: 0x1f03070, Func Offset: 0xc0
	// Line 946, Address: 0x1f0308c, Func Offset: 0xdc
	// Line 948, Address: 0x1f030a8, Func Offset: 0xf8
	// Line 949, Address: 0x1f030b8, Func Offset: 0x108
	// Line 951, Address: 0x1f030f4, Func Offset: 0x144
	// Func End, Address: 0x1f03104, Func Offset: 0x154
}

// 
// Start address: 0x1f03110
void EvAllTimeFunc()
{
	int j;
	int i;
	...
	// Line 959, Address: 0x1f03110, Func Offset: 0
	// Line 964, Address: 0x1f03128, Func Offset: 0x18
	// Line 965, Address: 0x1f0312c, Func Offset: 0x1c
	// Line 966, Address: 0x1f03160, Func Offset: 0x50
	// Line 968, Address: 0x1f03174, Func Offset: 0x64
	// Line 970, Address: 0x1f03190, Func Offset: 0x80
	// Line 971, Address: 0x1f0319c, Func Offset: 0x8c
	// Line 972, Address: 0x1f031a8, Func Offset: 0x98
	// Line 973, Address: 0x1f031b8, Func Offset: 0xa8
	// Line 975, Address: 0x1f03280, Func Offset: 0x170
	// Line 976, Address: 0x1f0328c, Func Offset: 0x17c
	// Line 978, Address: 0x1f03294, Func Offset: 0x184
	// Line 979, Address: 0x1f032a0, Func Offset: 0x190
	// Line 981, Address: 0x1f032a8, Func Offset: 0x198
	// Line 982, Address: 0x1f032b4, Func Offset: 0x1a4
	// Line 984, Address: 0x1f032bc, Func Offset: 0x1ac
	// Line 985, Address: 0x1f032c8, Func Offset: 0x1b8
	// Line 987, Address: 0x1f032d0, Func Offset: 0x1c0
	// Line 988, Address: 0x1f032dc, Func Offset: 0x1cc
	// Line 990, Address: 0x1f032e4, Func Offset: 0x1d4
	// Line 991, Address: 0x1f032f0, Func Offset: 0x1e0
	// Line 993, Address: 0x1f032f8, Func Offset: 0x1e8
	// Line 994, Address: 0x1f03304, Func Offset: 0x1f4
	// Line 996, Address: 0x1f0330c, Func Offset: 0x1fc
	// Line 997, Address: 0x1f03318, Func Offset: 0x208
	// Line 999, Address: 0x1f03320, Func Offset: 0x210
	// Line 1000, Address: 0x1f0332c, Func Offset: 0x21c
	// Line 1002, Address: 0x1f03334, Func Offset: 0x224
	// Line 1003, Address: 0x1f03340, Func Offset: 0x230
	// Line 1005, Address: 0x1f03348, Func Offset: 0x238
	// Line 1006, Address: 0x1f03354, Func Offset: 0x244
	// Line 1008, Address: 0x1f0335c, Func Offset: 0x24c
	// Line 1009, Address: 0x1f03368, Func Offset: 0x258
	// Line 1011, Address: 0x1f03370, Func Offset: 0x260
	// Line 1012, Address: 0x1f0337c, Func Offset: 0x26c
	// Line 1014, Address: 0x1f03384, Func Offset: 0x274
	// Line 1015, Address: 0x1f03390, Func Offset: 0x280
	// Line 1017, Address: 0x1f03398, Func Offset: 0x288
	// Line 1018, Address: 0x1f033a4, Func Offset: 0x294
	// Line 1020, Address: 0x1f033ac, Func Offset: 0x29c
	// Line 1023, Address: 0x1f033b8, Func Offset: 0x2a8
	// Line 1024, Address: 0x1f033cc, Func Offset: 0x2bc
	// Line 1025, Address: 0x1f033dc, Func Offset: 0x2cc
	// Line 1026, Address: 0x1f033e8, Func Offset: 0x2d8
	// Func End, Address: 0x1f03408, Func Offset: 0x2f8
}

// 
// Start address: 0x1f03410
int EvBgmControl()
{
	// Line 1032, Address: 0x1f03410, Func Offset: 0
	// Line 1033, Address: 0x1f03434, Func Offset: 0x24
	// Line 1035, Address: 0x1f03448, Func Offset: 0x38
	// Func End, Address: 0x1f03450, Func Offset: 0x40
}
...
// 
// Start address: 0x1f034b0
void EvCorpseSetCb18(int* list)
{
	// Line 1049, Address: 0x1f034b0, Func Offset: 0
	// Line 1050, Address: 0x1f034c0, Func Offset: 0x10
	// Line 1051, Address: 0x1f034d8, Func Offset: 0x28
	// Line 1052, Address: 0x1f034e8, Func Offset: 0x38
	// Line 1053, Address: 0x1f034fc, Func Offset: 0x4c
	// Line 1054, Address: 0x1f03514, Func Offset: 0x64
	// Func End, Address: 0x1f03528, Func Offset: 0x78
}

// 
// Start address: 0x1f03530
void EvCorpseSetCb26()
{
	// Line 1065, Address: 0x1f03530, Func Offset: 0
	// Func End, Address: 0x1f03538, Func Offset: 0x8
}

// 
// Start address: 0x1f03540
void EvWallSetCb19(int* list)
{
	// Line 1070, Address: 0x1f03540, Func Offset: 0
	// Line 1071, Address: 0x1f03550, Func Offset: 0x10
	// Line 1072, Address: 0x1f03560, Func Offset: 0x20
	// Line 1073, Address: 0x1f03578, Func Offset: 0x38
	// Line 1074, Address: 0x1f0358c, Func Offset: 0x4c
	// Line 1075, Address: 0x1f0359c, Func Offset: 0x5c
	// Func End, Address: 0x1f035b0, Func Offset: 0x70
}

// 
// Start address: 0x1f035b0
void EvWallSetCb20(int* list)
{
	// Line 1080, Address: 0x1f035b0, Func Offset: 0
	// Line 1081, Address: 0x1f035c0, Func Offset: 0x10
	// Line 1082, Address: 0x1f035d0, Func Offset: 0x20
	// Line 1083, Address: 0x1f035e8, Func Offset: 0x38
	// Line 1084, Address: 0x1f035fc, Func Offset: 0x4c
	// Line 1085, Address: 0x1f0360c, Func Offset: 0x5c
	// Func End, Address: 0x1f03620, Func Offset: 0x70
}

// 
// Start address: 0x1f03620
void EvWallSetCb21(int* list)
{
	// Line 1090, Address: 0x1f03620, Func Offset: 0
	// Line 1091, Address: 0x1f03630, Func Offset: 0x10
	// Line 1092, Address: 0x1f03640, Func Offset: 0x20
	// Line 1093, Address: 0x1f03658, Func Offset: 0x38
	// Line 1094, Address: 0x1f03668, Func Offset: 0x48
	// Line 1095, Address: 0x1f0367c, Func Offset: 0x5c
	// Line 1096, Address: 0x1f03684, Func Offset: 0x64
	// Line 1097, Address: 0x1f03690, Func Offset: 0x70
	// Line 1099, Address: 0x1f036a0, Func Offset: 0x80
	// Func End, Address: 0x1f036b4, Func Offset: 0x94
}

// 
// Start address: 0x1f036c0
void EvWallSetCb49(int* list)
{
	// Line 1104, Address: 0x1f036c0, Func Offset: 0
	// Line 1105, Address: 0x1f036c8, Func Offset: 0x8
	// Line 1106, Address: 0x1f036e0, Func Offset: 0x20
	// Line 1107, Address: 0x1f036f0, Func Offset: 0x30
	// Line 1108, Address: 0x1f03700, Func Offset: 0x40
	// Line 1110, Address: 0x1f03708, Func Offset: 0x48
	// Line 1111, Address: 0x1f03718, Func Offset: 0x58
	// Line 1112, Address: 0x1f03728, Func Offset: 0x68
	// Func End, Address: 0x1f03738, Func Offset: 0x78
}

// 
// Start address: 0x1f03740
void EvWallSetCb52(int* list)
{
	// Line 1118, Address: 0x1f03740, Func Offset: 0
	// Line 1119, Address: 0x1f03750, Func Offset: 0x10
	// Line 1120, Address: 0x1f0375c, Func Offset: 0x1c
	// Line 1121, Address: 0x1f03774, Func Offset: 0x34
	// Line 1122, Address: 0x1f03788, Func Offset: 0x48
	// Line 1123, Address: 0x1f03798, Func Offset: 0x58
	// Line 1124, Address: 0x1f037a8, Func Offset: 0x68
	// Line 1125, Address: 0x1f037b0, Func Offset: 0x70
	// Line 1126, Address: 0x1f037c4, Func Offset: 0x84
	// Line 1128, Address: 0x1f037d4, Func Offset: 0x94
	// Func End, Address: 0x1f037e8, Func Offset: 0xa8
}

// 
// Start address: 0x1f037f0
void EvSignalControlCb27(int* list)
{
	int i;
	// Line 1133, Address: 0x1f037f0, Func Offset: 0
	// Line 1144, Address: 0x1f03804, Func Offset: 0x14
	// Line 1145, Address: 0x1f03840, Func Offset: 0x50
	// Line 1146, Address: 0x1f03860, Func Offset: 0x70
	// Line 1147, Address: 0x1f0386c, Func Offset: 0x7c
	// Line 1148, Address: 0x1f03874, Func Offset: 0x84
	// Line 1149, Address: 0x1f03888, Func Offset: 0x98
	// Line 1150, Address: 0x1f03890, Func Offset: 0xa0
	// Line 1153, Address: 0x1f038c4, Func Offset: 0xd4
	// Line 1154, Address: 0x1f038d8, Func Offset: 0xe8
	// Line 1155, Address: 0x1f038f4, Func Offset: 0x104
	// Line 1156, Address: 0x1f03900, Func Offset: 0x110
	// Line 1157, Address: 0x1f03918, Func Offset: 0x128
	// Line 1158, Address: 0x1f03924, Func Offset: 0x134
	// Line 1160, Address: 0x1f03940, Func Offset: 0x150
	// Line 1162, Address: 0x1f03954, Func Offset: 0x164
	// Line 1165, Address: 0x1f0395c, Func Offset: 0x16c
	// Line 1166, Address: 0x1f03998, Func Offset: 0x1a8
	// Line 1167, Address: 0x1f039b4, Func Offset: 0x1c4
	// Line 1169, Address: 0x1f039c0, Func Offset: 0x1d0
	// Line 1170, Address: 0x1f039d4, Func Offset: 0x1e4
	// Line 1172, Address: 0x1f039f0, Func Offset: 0x200
	// Line 1173, Address: 0x1f03a04, Func Offset: 0x214
	// Func End, Address: 0x1f03a1c, Func Offset: 0x22c
}
...
// 
// Start address: 0x1f03c50
void EvSignalControlCb29(int* list)
{
	// Line 1214, Address: 0x1f03c50, Func Offset: 0
	// Line 1217, Address: 0x1f03c60, Func Offset: 0x10
	// Line 1218, Address: 0x1f03c9c, Func Offset: 0x4c
	// Line 1219, Address: 0x1f03cbc, Func Offset: 0x6c
	// Line 1226, Address: 0x1f03cc8, Func Offset: 0x78
	// Line 1227, Address: 0x1f03cdc, Func Offset: 0x8c
	// Line 1228, Address: 0x1f03cf8, Func Offset: 0xa8
	// Line 1229, Address: 0x1f03d04, Func Offset: 0xb4
	// Line 1230, Address: 0x1f03d1c, Func Offset: 0xcc
	// Line 1231, Address: 0x1f03d28, Func Offset: 0xd8
	// Line 1233, Address: 0x1f03d44, Func Offset: 0xf4
	// Line 1238, Address: 0x1f03d58, Func Offset: 0x108
	// Line 1239, Address: 0x1f03d94, Func Offset: 0x144
	// Line 1240, Address: 0x1f03db0, Func Offset: 0x160
	// Line 1242, Address: 0x1f03dbc, Func Offset: 0x16c
	// Line 1243, Address: 0x1f03dd0, Func Offset: 0x180
	// Line 1245, Address: 0x1f03dec, Func Offset: 0x19c
	// Line 1246, Address: 0x1f03e00, Func Offset: 0x1b0
	// Func End, Address: 0x1f03e14, Func Offset: 0x1c4
}

// 
// Start address: 0x1f03e20
void EvSignalControlCb35(int* list)
{
	int i;
	// Line 1251, Address: 0x1f03e20, Func Offset: 0
	// Line 1262, Address: 0x1f03e34, Func Offset: 0x14
	// Line 1263, Address: 0x1f03e70, Func Offset: 0x50
	// Line 1264, Address: 0x1f03e90, Func Offset: 0x70
	// Line 1265, Address: 0x1f03e9c, Func Offset: 0x7c
	// Line 1266, Address: 0x1f03ea4, Func Offset: 0x84
	// Line 1267, Address: 0x1f03eb8, Func Offset: 0x98
	// Line 1268, Address: 0x1f03ec0, Func Offset: 0xa0
	// Line 1271, Address: 0x1f03ef4, Func Offset: 0xd4
	// Line 1272, Address: 0x1f03f08, Func Offset: 0xe8
	// Line 1273, Address: 0x1f03f24, Func Offset: 0x104
	// Line 1274, Address: 0x1f03f30, Func Offset: 0x110
	// Line 1275, Address: 0x1f03f48, Func Offset: 0x128
	// Line 1276, Address: 0x1f03f54, Func Offset: 0x134
	// Line 1278, Address: 0x1f03f70, Func Offset: 0x150
	// Line 1280, Address: 0x1f03f84, Func Offset: 0x164
	// Line 1283, Address: 0x1f03f8c, Func Offset: 0x16c
	// Line 1284, Address: 0x1f03fc8, Func Offset: 0x1a8
	// Line 1285, Address: 0x1f03fe4, Func Offset: 0x1c4
	// Line 1287, Address: 0x1f03ff0, Func Offset: 0x1d0
	// Line 1288, Address: 0x1f04004, Func Offset: 0x1e4
	// Line 1290, Address: 0x1f04020, Func Offset: 0x200
	// Line 1291, Address: 0x1f04034, Func Offset: 0x214
	// Func End, Address: 0x1f0404c, Func Offset: 0x22c
}

// 
// Start address: 0x1f04050
void EvSignalControlCb36(int* list)
{
	// Line 1296, Address: 0x1f04050, Func Offset: 0
	// Line 1299, Address: 0x1f04060, Func Offset: 0x10
	// Line 1300, Address: 0x1f0409c, Func Offset: 0x4c
	// Line 1301, Address: 0x1f040bc, Func Offset: 0x6c
	// Line 1308, Address: 0x1f040c8, Func Offset: 0x78
	// Line 1309, Address: 0x1f040dc, Func Offset: 0x8c
	// Line 1310, Address: 0x1f040f8, Func Offset: 0xa8
	// Line 1311, Address: 0x1f04104, Func Offset: 0xb4
	// Line 1312, Address: 0x1f0411c, Func Offset: 0xcc
	// Line 1313, Address: 0x1f04128, Func Offset: 0xd8
	// Line 1315, Address: 0x1f04144, Func Offset: 0xf4
	// Line 1320, Address: 0x1f04158, Func Offset: 0x108
	// Line 1321, Address: 0x1f04194, Func Offset: 0x144
	// Line 1322, Address: 0x1f041b0, Func Offset: 0x160
	// Line 1324, Address: 0x1f041bc, Func Offset: 0x16c
	// Line 1325, Address: 0x1f041d0, Func Offset: 0x180
	// Line 1327, Address: 0x1f041ec, Func Offset: 0x19c
	// Line 1328, Address: 0x1f04200, Func Offset: 0x1b0
	// Func End, Address: 0x1f04214, Func Offset: 0x1c4
}

// 
// Start address: 0x1f04220
void EvSignalControlCb37(int* list)
{
	int i;
	// Line 1332, Address: 0x1f04220, Func Offset: 0
	// Line 1335, Address: 0x1f04230, Func Offset: 0x10
	// Line 1336, Address: 0x1f04248, Func Offset: 0x28
	// Line 1338, Address: 0x1f04258, Func Offset: 0x38
	// Line 1339, Address: 0x1f04294, Func Offset: 0x74
	// Line 1340, Address: 0x1f042b4, Func Offset: 0x94
	// Line 1341, Address: 0x1f042d4, Func Offset: 0xb4
	// Line 1343, Address: 0x1f042e0, Func Offset: 0xc0
	// Line 1344, Address: 0x1f042f4, Func Offset: 0xd4
	// Line 1345, Address: 0x1f042fc, Func Offset: 0xdc
	// Line 1348, Address: 0x1f04330, Func Offset: 0x110
	// Line 1349, Address: 0x1f04344, Func Offset: 0x124
	// Line 1350, Address: 0x1f04360, Func Offset: 0x140
	// Line 1351, Address: 0x1f0436c, Func Offset: 0x14c
	// Line 1352, Address: 0x1f04384, Func Offset: 0x164
	// Line 1353, Address: 0x1f04390, Func Offset: 0x170
	// Line 1355, Address: 0x1f043ac, Func Offset: 0x18c
	// Line 1360, Address: 0x1f043c0, Func Offset: 0x1a0
	// Line 1361, Address: 0x1f043fc, Func Offset: 0x1dc
	// Line 1362, Address: 0x1f04418, Func Offset: 0x1f8
	// Line 1364, Address: 0x1f04424, Func Offset: 0x204
	// Line 1365, Address: 0x1f04438, Func Offset: 0x218
	// Line 1367, Address: 0x1f04454, Func Offset: 0x234
	// Line 1368, Address: 0x1f04468, Func Offset: 0x248
	// Func End, Address: 0x1f0447c, Func Offset: 0x25c
}

// 
// Start address: 0x1f04480
void EvTapeSetCb11(int* list)
{
	// Line 1374, Address: 0x1f04480, Func Offset: 0
	// Line 1375, Address: 0x1f04488, Func Offset: 0x8
	// Line 1376, Address: 0x1f044a0, Func Offset: 0x20
	// Line 1378, Address: 0x1f044b8, Func Offset: 0x38
	// Line 1379, Address: 0x1f044c8, Func Offset: 0x48
	// Line 1381, Address: 0x1f044d8, Func Offset: 0x58
	// Func End, Address: 0x1f044e8, Func Offset: 0x68
}

// 
// Start address: 0x1f044f0
void EvTapeSetCb12(int* list)
{
	// Line 1386, Address: 0x1f044f0, Func Offset: 0
	// Line 1387, Address: 0x1f044f8, Func Offset: 0x8
	// Line 1388, Address: 0x1f04510, Func Offset: 0x20
	// Line 1390, Address: 0x1f04528, Func Offset: 0x38
	// Line 1391, Address: 0x1f04538, Func Offset: 0x48
	// Line 1393, Address: 0x1f04548, Func Offset: 0x58
	// Func End, Address: 0x1f04558, Func Offset: 0x68
}

// 
// Start address: 0x1f04560
float LinearTrim(float Yen, float Yst, float Xen, float Xst, float Parm)
{
	// Line 1420, Address: 0x1f04560, Func Offset: 0
	// Line 1421, Address: 0x1f04580, Func Offset: 0x20
	// Func End, Address: 0x1f04588, Func Offset: 0x28
}

// 
// Start address: 0x1f04590
void CB_1stMoster_FogHosei()
{
	float dist;
	float ffar;
	...
	float ddt;
	float campos[4];
	// Line 1430, Address: 0x1f04590, Func Offset: 0
	// Line 1431, Address: 0x1f0459c, Func Offset: 0xc
	// Line 1437, Address: 0x1f045dc, Func Offset: 0x4c
	// Line 1438, Address: 0x1f045e8, Func Offset: 0x58
	// Line 1441, Address: 0x1f04630, Func Offset: 0xa0
	// Line 1442, Address: 0x1f04644, Func Offset: 0xb4
	// Line 1443, Address: 0x1f04658, Func Offset: 0xc8
	// Line 1444, Address: 0x1f04668, Func Offset: 0xd8
	// Line 1446, Address: 0x1f04670, Func Offset: 0xe0
	// Line 1447, Address: 0x1f04684, Func Offset: 0xf4
	// Line 1448, Address: 0x1f04698, Func Offset: 0x108
	// Line 1450, Address: 0x1f046a8, Func Offset: 0x118
	// Line 1454, Address: 0x1f046b0, Func Offset: 0x120
	// Line 1456, Address: 0x1f046e0, Func Offset: 0x150
	// Line 1457, Address: 0x1f04710, Func Offset: 0x180
	// Line 1458, Address: 0x1f0471c, Func Offset: 0x18c
	// Line 1459, Address: 0x1f0474c, Func Offset: 0x1bc
	// Line 1463, Address: 0x1f04758, Func Offset: 0x1c8
	// Line 1466, Address: 0x1f04760, Func Offset: 0x1d0
	// Line 1469, Address: 0x1f04774, Func Offset: 0x1e4
	// Line 1470, Address: 0x1f04780, Func Offset: 0x1f0
	// Line 1472, Address: 0x1f047c0, Func Offset: 0x230
	// Line 1474, Address: 0x1f047d0, Func Offset: 0x240
	// Line 1476, Address: 0x1f047f4, Func Offset: 0x264
	// Line 1477, Address: 0x1f04828, Func Offset: 0x298
	// Line 1478, Address: 0x1f04834, Func Offset: 0x2a4
	// Line 1479, Address: 0x1f04864, Func Offset: 0x2d4
	// Line 1481, Address: 0x1f04870, Func Offset: 0x2e0
	// Line 1482, Address: 0x1f04878, Func Offset: 0x2e8
	// Line 1483, Address: 0x1f0488c, Func Offset: 0x2fc
	// Line 1484, Address: 0x1f048a0, Func Offset: 0x310
	// Line 1489, Address: 0x1f048b0, Func Offset: 0x320
	// Func End, Address: 0x1f048c4, Func Offset: 0x334
}

// 
// Start address: 0x1f048d0
void CB_1stMonster_Filter()
{
	FilterParams* pfp;
	float campos[4];
	// Line 1493, Address: 0x1f048d0, Func Offset: 0
	// Line 1495, Address: 0x1f048dc, Func Offset: 0xc
	// Line 1497, Address: 0x1f048e8, Func Offset: 0x18
	// Line 1502, Address: 0x1f04954, Func Offset: 0x84
	// Line 1505, Address: 0x1f04960, Func Offset: 0x90
	// Line 1507, Address: 0x1f04968, Func Offset: 0x98
	// Line 1516, Address: 0x1f04974, Func Offset: 0xa4
	// Line 1517, Address: 0x1f0497c, Func Offset: 0xac
	// Line 1518, Address: 0x1f04984, Func Offset: 0xb4
	// Line 1519, Address: 0x1f0498c, Func Offset: 0xbc
	// Line 1520, Address: 0x1f04994, Func Offset: 0xc4
	// Line 1521, Address: 0x1f0499c, Func Offset: 0xcc
	// Line 1523, Address: 0x1f049a0, Func Offset: 0xd0
	// Line 1524, Address: 0x1f049a8, Func Offset: 0xd8
	// Line 1526, Address: 0x1f049bc, Func Offset: 0xec
	// Line 1530, Address: 0x1f049c4, Func Offset: 0xf4
	// Func End, Address: 0x1f049d8, Func Offset: 0x108
}

// 
// Start address: 0x1f049e0
void Draw_CB_Tonnel()
{
	float campos[4];
	int i;
	...
	Q_WORDDATA* kickbuf;
	Q_WORDDATA env[8];
	// Line 1578, Address: 0x1f049e0, Func Offset: 0
	// Line 1579, Address: 0x1f049ec, Func Offset: 0xc
	// Line 1580, Address: 0x1f049f8, Func Offset: 0x18
	// Line 1585, Address: 0x1f04a04, Func Offset: 0x24
	// Line 1590, Address: 0x1f04a2c, Func Offset: 0x4c
	// Line 1591, Address: 0x1f04a38, Func Offset: 0x58
	// Line 1592, Address: 0x1f04a44, Func Offset: 0x64
	// Line 1593, Address: 0x1f04a6c, Func Offset: 0x8c
	// Line 1596, Address: 0x1f04a7c, Func Offset: 0x9c
	// Line 1597, Address: 0x1f04ab0, Func Offset: 0xd0
	// Line 1599, Address: 0x1f04ad8, Func Offset: 0xf8
	// Line 1609, Address: 0x1f04b1c, Func Offset: 0x13c
	// Line 1615, Address: 0x1f04b38, Func Offset: 0x158
	// Line 1616, Address: 0x1f04b60, Func Offset: 0x180
	// Line 1618, Address: 0x1f04b7c, Func Offset: 0x19c
	// Line 1619, Address: 0x1f04b88, Func Offset: 0x1a8
	// Line 1621, Address: 0x1f04bb4, Func Offset: 0x1d4
	// Line 1623, Address: 0x1f04bc0, Func Offset: 0x1e0
	// Line 1624, Address: 0x1f04bc8, Func Offset: 0x1e8
	// Line 1625, Address: 0x1f04bd4, Func Offset: 0x1f4
	// Line 1626, Address: 0x1f04bdc, Func Offset: 0x1fc
	// Line 1627, Address: 0x1f04be8, Func Offset: 0x208
	// Line 1628, Address: 0x1f04c04, Func Offset: 0x224
	// Line 1630, Address: 0x1f04c3c, Func Offset: 0x25c
	// Line 1632, Address: 0x1f04c78, Func Offset: 0x298
	// Line 1633, Address: 0x1f04c88, Func Offset: 0x2a8
	// Line 1634, Address: 0x1f04c98, Func Offset: 0x2b8
	// Line 1638, Address: 0x1f04ca8, Func Offset: 0x2c8
	// Func End, Address: 0x1f04cbc, Func Offset: 0x2dc
}
