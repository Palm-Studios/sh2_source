...
typedef Model_List type_7[4];
typedef Event_List type_8[14];
...
typedef _AnimeInfo type_27[24];
typedef unsigned char type_28[14];
typedef Enemy_List type_29[5];
typedef float type_30[4][2];
typedef float type_31[4];
typedef unsigned int type_32[255];
typedef Item_List type_33[4];
...
typedef unsigned char type_46[144];
typedef unsigned char type_47[0];
...
unsigned char __otn_kick_key_00[0];
float demo_frame;
char* dds_adr;
...
void EvRoomInit();
void EvProgSubScreamOn();

// 
// Start address: 0x1f01e80
int EvProgLauraKickKey()
{
	float yard_key_after_data[4][2];
	DramaDemo_PlayInfo kick;
	CharaData_DemoList kagikeri_data[4];
...
// 
// Start address: 0x1f02210
void EvRoomInit()
{
	// Line 211, Address: 0x1f02210, Func Offset: 0
	// Func End, Address: 0x1f02218, Func Offset: 0x8
}
