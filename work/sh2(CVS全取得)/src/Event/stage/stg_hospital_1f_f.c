...
typedef Enemy_List type_1[1];
typedef CharaData_DemoList type_4[6];
typedef int(*type_5)()[9];
typedef _AnimeInfo type_6[33];
typedef unsigned char type_7[642];
...
typedef _AnimeInfo type_26[34];
typedef _AnimeInfo type_27[17];
typedef Event_List type_28[62];
...
unsigned char ev_pos[642];
Event_List ev_list[62];
Item_List gi_list[23];
int(*ev_prog)()[9];
Model_List mdl_list[6];
Enemy_List en_list[1];
Stage_Data stage_hospital_1f_f;
<unknown fundamental type (0xa510)>* jms_anim_adr;
<unknown fundamental type (0xa510)>* mar_anim_adr;
char* dds_adr;
...
fsFileIndex data_demo_hp_exit_hp_exit_dds[1];
fsFileIndex data_demo_hp_exit_lll_mar_anm[1];
fsFileIndex data_demo_hp_exit_hll_jms_anm[1];
_SH2_SYS Sh2sys;
...
int EvProgHospitalExit();
int EvProgLauraDeceive1st();
...
void EvRoomInit()
{
	...
	// Line 497, Address: 0x1f02b50, Func Offset: 0
	// Line 518, Address: 0x1f02b58, Func Offset: 0x8
	// Line 520, Address: 0x1f02b60, Func Offset: 0x10
	// Line 521, Address: 0x1f02b6c, Func Offset: 0x1c
	// Line 522, Address: 0x1f02b84, Func Offset: 0x34
	// Line 524, Address: 0x1f02ba0, Func Offset: 0x50
	// Line 526, Address: 0x1f02bbc, Func Offset: 0x6c
	// Line 528, Address: 0x1f02bd8, Func Offset: 0x88
	// Line 530, Address: 0x1f02be8, Func Offset: 0x98
	// Line 531, Address: 0x1f02bfc, Func Offset: 0xac
	// Line 532, Address: 0x1f02c10, Func Offset: 0xc0
	// Line 534, Address: 0x1f02c2c, Func Offset: 0xdc
	// Line 535, Address: 0x1f02c3c, Func Offset: 0xec
	// Line 536, Address: 0x1f02c44, Func Offset: 0xf4
	// Line 537, Address: 0x1f02c60, Func Offset: 0x110
	// Line 539, Address: 0x1f02c70, Func Offset: 0x120
	// Func End, Address: 0x1f02c80, Func Offset: 0x130
}
...
// 
// Start address: 0x1f02d90
int EvBgmControl()
{
	// Line 574, Address: 0x1f02d90, Func Offset: 0
	// Line 575, Address: 0x1f02d98, Func Offset: 0x8
	// Line 576, Address: 0x1f02dc4, Func Offset: 0x34
	// Line 577, Address: 0x1f02dd0, Func Offset: 0x40
	// Line 578, Address: 0x1f02dd4, Func Offset: 0x44
	// Func End, Address: 0x1f02de4, Func Offset: 0x54
}
