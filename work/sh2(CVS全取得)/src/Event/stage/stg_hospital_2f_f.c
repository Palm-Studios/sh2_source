...
typedef unsigned char type_3[462];
typedef Model_List type_4[4];
typedef unsigned char type_5[97];
typedef CharaData_DemoList type_6[4];
...
typedef CharaData_DemoList type_25[5];
typedef Event_List type_26[42];
typedef Enemy_List type_27[7];
...
unsigned char ev_pos[462];
Event_List ev_list[42];
Item_List gi_list[22];
int(*ev_prog)()[7];
...
int EvProgNeedleInAnimal()
{
	...
	int drm;
	SubCharacter* scp;
	DramaDemo_PlayInfo needle_a;
	DramaDemo_PlayInfo needle_b;
...
// 
// Start address: 0x1f02700
int EvProgGetShotgun()
{
	// Line 338, Address: 0x1f02700, Func Offset: 0
	// Line 339, Address: 0x1f02708, Func Offset: 0x8
	// Line 340, Address: 0x1f02718, Func Offset: 0x18
	// Func End, Address: 0x1f02728, Func Offset: 0x28
}

// 
// Start address: 0x1f02730
int EvCharaDataClear(int room)
{
	// Line 346, Address: 0x1f02730, Func Offset: 0
	// Line 347, Address: 0x1f02754, Func Offset: 0x24
	// Line 348, Address: 0x1f02760, Func Offset: 0x30
	// Line 349, Address: 0x1f02764, Func Offset: 0x34
	// Func End, Address: 0x1f0276c, Func Offset: 0x3c
}
...
void EvRoomInit()
{
	CharaData_DemoList chara_a[4];
	CharaData_DemoList chara_b[5];
