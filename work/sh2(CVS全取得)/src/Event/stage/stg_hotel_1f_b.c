...
typedef float type_29[4][5];
typedef _AnimeInfo type_30[34];
typedef unsigned char type_31[482];
...
typedef unsigned char type_37[14];
typedef PAD_INFO type_38[10];
typedef Model_List type_39[5];
...
typedef Enemy_List type_60[8];
typedef unsigned short type_61[0];
typedef _AnimeInfo type_62[12];
...
Event_List ev_list[47];
Item_List gi_list[5];
int(*ev_prog)()[6];
Model_List mdl_list[5];
Enemy_List en_list[8];
Stage_Data stage_hotel_1f_b;
<unknown fundamental type (0xa510)>* play_anim;
<unknown fundamental type (0xa510)>* demo_anim;
char* demo_dds;
float egg[4][2][4];
shPlayerWork sh2jms;
fsFileIndex data_chr_oni_oni_anm[1];
int ev_s_step;
int ev_p_step;
fsFileIndex data_demo_red_ceo_red_ceo_dds[1];
fsFileIndex data_demo_red_ceo_oni_anm[1];
char MemShare_gp_data_buf[0];
fsFileIndex data_demo_red_taiketsu_red_taiketsu_dds[1];
_anon1 game_flag;
...
unsigned char egg_side;
char* layer_adr;

int EvProgTriheadBattle();
int EvProgTriheadDead();
...
{
	float vec[4][5];
	DramaDemo_PlayInfo battle;
	CharaData_DemoList battle_data[4];
...
// 
// Start address: 0x1f020e0
int EvProgTriheadDead()
{
	float rot[4];
	float pos[4][2];
	DramaDemo_PlayInfo dead;
	// Line 221, Address: 0x1f020e0, Func Offset: 0
	// Line 237, Address: 0x1f020e8, Func Offset: 0x8
	// Line 239, Address: 0x1f02118, Func Offset: 0x38
	// Line 240, Address: 0x1f02128, Func Offset: 0x48
	// Line 242, Address: 0x1f02148, Func Offset: 0x68
	// Line 243, Address: 0x1f02154, Func Offset: 0x74
	// Line 244, Address: 0x1f02168, Func Offset: 0x88
	// Line 245, Address: 0x1f0217c, Func Offset: 0x9c
	// Line 246, Address: 0x1f02190, Func Offset: 0xb0
	// Line 249, Address: 0x1f021a4, Func Offset: 0xc4
	// Line 250, Address: 0x1f021d0, Func Offset: 0xf0
	// Line 253, Address: 0x1f021d8, Func Offset: 0xf8
	// Line 254, Address: 0x1f021ec, Func Offset: 0x10c
	// Line 255, Address: 0x1f021f4, Func Offset: 0x114
	// Line 256, Address: 0x1f02200, Func Offset: 0x120
	// Line 258, Address: 0x1f02220, Func Offset: 0x140
	// Line 259, Address: 0x1f02228, Func Offset: 0x148
	// Line 261, Address: 0x1f02248, Func Offset: 0x168
	// Line 263, Address: 0x1f0226c, Func Offset: 0x18c
	// Line 264, Address: 0x1f02278, Func Offset: 0x198
	// Line 266, Address: 0x1f02284, Func Offset: 0x1a4
	// Line 267, Address: 0x1f02288, Func Offset: 0x1a8
	// Func End, Address: 0x1f02298, Func Offset: 0x1b8
}
