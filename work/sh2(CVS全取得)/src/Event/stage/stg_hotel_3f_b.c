...
typedef Model_List type_19[1];
typedef Event_List type_20[12];
typedef _AnimeInfo type_21[24];
typedef unsigned char type_22[14];
typedef _AnimeInfo type_23[5];
typedef _AnimeInfo type_24[19];
