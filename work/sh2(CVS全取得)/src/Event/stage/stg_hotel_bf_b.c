...
unsigned char ev_pos[258];
Event_List ev_list[21];
Item_List gi_list[11];
_CL_HITPOLY_PLANE clActWallList_ru13[2];
int(*ev_prog)()[3];
...
float elv_spd;
float elv_pos;
Event_CamSetData cam_data_0;
Event_CamSetData cam_data_1;
shPlayerWork sh2jms;
int ev_s_step;
int ev_p_step;
_anon7 game_flag;
...
int EvProgElevatorOutCamChange();
void EvRoomInit();
void EvAllTimeFunc();
