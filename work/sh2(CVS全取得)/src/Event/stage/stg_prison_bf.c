...
typedef Event_List type_34[17];
typedef PAD_INFO type_35[10];
typedef int(*type_36)()[6];
...
typedef unsigned char type_57[14];
...
int ev_s_step;
int ev_p_step;
fsFileIndex data_demo_5f_start_hll_jms_anm[1];
char MemShare_gp_data_buf[0];
fsFileIndex data_demo_5f_start_5f_start_dds[1];
_anon1 game_flag;
float total_demo_frame;
float demo_frame;
fsFileIndex data_demo_jump4_hll_jms_anm[1];
fsFileIndex data_demo_jump4_jump4_dds[1];
fsFileIndex data_demo_6f_start_hll_jms_anm[1];
fsFileIndex data_demo_6f_start_6f_start_dds[1];
fsFileIndex data_demo_jump5_hll_jms_anm[1];
fsFileIndex data_demo_jump5_jump5_dds[1];

int EvProg5thLayerStart();
int EvProgHoleTo6thLayer();
int EvProg6thLayerStart();
...
// 
// Start address: 0x1f02980
void EvAllTimeFunc()
{
	int disp_ctrl_list[3];
	// Line 323, Address: 0x1f02980, Func Offset: 0
	// Line 326, Address: 0x1f02988, Func Offset: 0x8
	// Line 328, Address: 0x1f0298c, Func Offset: 0xc
	// Line 330, Address: 0x1f029a8, Func Offset: 0x28
	// Line 331, Address: 0x1f029bc, Func Offset: 0x3c
	// Line 332, Address: 0x1f029d4, Func Offset: 0x54
	// Line 333, Address: 0x1f029e4, Func Offset: 0x64
	// Line 338, Address: 0x1f029f8, Func Offset: 0x78
	// Line 339, Address: 0x1f02a04, Func Offset: 0x84
	// Func End, Address: 0x1f02a14, Func Offset: 0x94
}
