...
typedef void(*type_6)();
typedef int(*type_31)();
typedef void(*type_71)(SubCharacter*);
typedef void(*type_73)(SubCharacter*);

typedef unsigned char type_0[97];
typedef Q_WORDDATA type_1[2];
typedef Q_WORDDATA type_2[2];
typedef _AnimeInfo type_3[2];
...
typedef unsigned char type_29[20];
...
typedef unsigned char type_55[14];
...
// 
// Start address: 0x1f02190
void EvStageInit()
{
	// Line 167, Address: 0x1f02190, Func Offset: 0
	// Func End, Address: 0x1f02198, Func Offset: 0x8
}

// 
// Start address: 0x1f021a0
int EvBgmControl()
{
	// Line 173, Address: 0x1f021a0, Func Offset: 0
	// Line 174, Address: 0x1f021c4, Func Offset: 0x24
	// Line 176, Address: 0x1f021d8, Func Offset: 0x38
	// Func End, Address: 0x1f021e0, Func Offset: 0x40
}
...
// 
// Start address: 0x1f02430
float LinearTrim(float Yen, float Yst, float Xen, float Xst, float Parm)
{
	// Line 282, Address: 0x1f02430, Func Offset: 0
	// Line 283, Address: 0x1f02450, Func Offset: 0x20
	// Func End, Address: 0x1f02458, Func Offset: 0x28
}

// 
// Start address: 0x1f02460
void Toilet_Dof_Filter()
{
	FilterParams* pfp;
	float dal;
	float toilet_dt;
	int demo_switch;
	// Line 289, Address: 0x1f02460, Func Offset: 0
	// Line 294, Address: 0x1f02470, Func Offset: 0x10
	// Line 295, Address: 0x1f02484, Func Offset: 0x24
	// Line 297, Address: 0x1f02490, Func Offset: 0x30
	// Line 299, Address: 0x1f024a0, Func Offset: 0x40
	// Line 301, Address: 0x1f024bc, Func Offset: 0x5c
	// Line 304, Address: 0x1f024d0, Func Offset: 0x70
	// Line 306, Address: 0x1f024d8, Func Offset: 0x78
	// Line 307, Address: 0x1f024e4, Func Offset: 0x84
	// Line 309, Address: 0x1f02514, Func Offset: 0xb4
	// Line 311, Address: 0x1f02534, Func Offset: 0xd4
	// Line 313, Address: 0x1f0253c, Func Offset: 0xdc
	// Line 316, Address: 0x1f0254c, Func Offset: 0xec
	// Line 317, Address: 0x1f02554, Func Offset: 0xf4
	// Line 319, Address: 0x1f0255c, Func Offset: 0xfc
	// Line 321, Address: 0x1f02564, Func Offset: 0x104
	// Line 324, Address: 0x1f02580, Func Offset: 0x120
	// Line 325, Address: 0x1f02588, Func Offset: 0x128
	// Line 327, Address: 0x1f02590, Func Offset: 0x130
	// Line 329, Address: 0x1f02598, Func Offset: 0x138
	// Line 331, Address: 0x1f025a8, Func Offset: 0x148
	// Line 333, Address: 0x1f025b0, Func Offset: 0x150
	// Line 334, Address: 0x1f025c4, Func Offset: 0x164
	// Line 336, Address: 0x1f025cc, Func Offset: 0x16c
	// Line 339, Address: 0x1f025d4, Func Offset: 0x174
	// Func End, Address: 0x1f025ec, Func Offset: 0x18c
}
